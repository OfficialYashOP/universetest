        ...
        <div className="space-y-8">
          <section className="bg-card border border-border rounded-xl p-6">
            <p className="text-muted-foreground leading-relaxed">
              Welcome to UniVerse! These Terms of Service govern your use of our platform. 
              By creating an account or using UniVerse, you agree to these terms. 
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-4">
              <p className="text-muted-foreground">To use UniVerse, you must:</p>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-4">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>Use UniVerse for lawful purposes only</li>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-4">
              ...
              <div>
                <h3 className="font-semibold mb-2">UniVerse Content</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  <li>The UniVerse platform, logo, design, and features are our intellectual property</li>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-4">
              <p className="text-muted-foreground">UniVerse reserves the right to:</p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-4">
              <p className="text-muted-foreground">
                UniVerse is provided "as is" without warranties of any kind. To the maximum extent permitted by law:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <ul className="list-disc list-inside text-muted-foreground mt-3 space-y-1">
                ...
                <li>Continued use of UniVerse after changes constitutes acceptance</li>
              </ul>
            </div>
          </section>
